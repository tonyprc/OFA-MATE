...
class UIMainWindow(QMainWindow):
    ...
    json_en_filler = pyqtSignal()
    json_zh_filler = pyqtSignal()
    json_en_refiller = pyqtSignal()
    json_zh_refiller = pyqtSignal()
    ...
    def __init__(self,parent = None):
        ...
        self._ss_book_redoButton.clicked[bool].connect(self.json_en_refiller)
        self._ss_book_uploadButton = QPushButton("提交")
        self._ss_book_uploadButton.setFixedWidth(80)
        self._ss_book_uploadButton.clicked[bool].connect(self.json_en_filler)
        ...
        self._tt_book_redoButton.clicked[bool].connect(self.json_zh_refiller)
        self._tt_book_uploadButton = QPushButton("提交")
        self._tt_book_uploadButton.setFixedWidth(80)
        self._tt_book_uploadButton.clicked[bool].connect(self.json_zh_filler)
