...
USAGE: Run the tool, read the promts on the upper part of the window, choose "file type" among txt, docx, and xlsx, thoose "bind type" between single file and multi-files,
